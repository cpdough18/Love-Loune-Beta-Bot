...
exports.run = function (client, message, args, args2, cmd) {
    ...
    const embedNew = new Discord.RichEmbed()
        ...
        .addField(`:tools: **General**`, `commands, help, avatar, avasteal, checklist, color, date, embed, iplookup (your ip will NOT be logged!), ping`, true)
        ...
        .addField(`:information_source: **Information**`, `botinfo, game, serverinfo, userid, userinfo`, true)
