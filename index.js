    ...
    if (command === "killall") {
        ...
        if (message.author.id === config.owner) {
            ...
            if (!args.join(' ')) {
                ...
                message.channel.send("Success! View host console for more information. Love Lounge's Bot shutting down...")
                console.log(chalk.green("Love Lounge's Bot has been shutdown via Discord Chatbox."))
